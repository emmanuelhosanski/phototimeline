    ...
    `,o=e.gameOver?`
      <section class="game-over-modal">
        <div class="game-over-card">
          ...
          ${e.gameOverMessage?`<p class="panel-message">${e.gameOverMessage}</p>`:""}
